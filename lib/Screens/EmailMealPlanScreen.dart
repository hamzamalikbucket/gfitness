...
class EmailMealPlanScreen extends StatefulWidget {
  const EmailMealPlanScreen({Key? key}) : super(key: key);
...
class BookState extends State<EmailMealPlanScreen> {
  ...
  Future<void> send() async {
    final Email Semail = Email(
      body:"Name:$name\nCustomer Email:$email \n Gender:${Utils.userGender}\n "
          "User Age:${Utils.User_DOB}\n "
          "User height:${Utils.userHeight}\n"
          "User Weight:${Utils.userWeight}\n"
          "User Activity:${Utils.user_activity}\n"
          " UserGoal:${Utils.user_goal}",
      subject: "Request for a Meal Plan",
