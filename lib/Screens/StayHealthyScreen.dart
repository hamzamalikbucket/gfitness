...
class StayHealthyScreen extends StatefulWidget{
  const StayHealthyScreen({Key? key}) : super(key: key);
...
class HealthState extends State<StayHealthyScreen>{
String data='';

fetchFileData() async{
  String responsetext;
  responsetext=await rootBundle.loadString("assets/images/stayhealthy.txt");
  setState(() {
    data=responsetext;
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:ToolbarBack(appBar: AppBar(), title: "Stay Healthy "),
      body: SafeArea(
        child: Container(
