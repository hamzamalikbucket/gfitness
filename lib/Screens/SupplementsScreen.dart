...
class SupState extends State<SupplementsScreen>{
  String data='';
  BannerAd? _bannerAd;

  fetchFileData() async{
    String responsetext;
    responsetext=await rootBundle.loadString("assets/images/supplements.txt");
    setState(() {
      data=responsetext;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:ToolbarBack(appBar: AppBar(), title: "Supplements"),
      body: SafeArea(
        child: Container(
